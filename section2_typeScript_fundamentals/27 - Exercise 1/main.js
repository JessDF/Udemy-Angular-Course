...
When a user clicks the "Like" button below a post,
    the button is highlighted (to indicate that it is selected) and the number of likes is increased.
...
It also responds to user actions.
So, when the user clicks the "Like" button, the number of likes should be increased and the button should be in the "selected/on" state.
...
var likePost = new like_component_1.LikeComponent(10, true);
likePost.onClick();
console.log("likesCount: " + likePost.likesCount + ", isSelected: " + likePost.isSelected);
likePost.onClick();
console.log("likesCount: " + likePost.likesCount + ", isSelected: " + likePost.isSelected);
